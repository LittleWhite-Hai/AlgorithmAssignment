...
public class Point implements Comparable<Point> {
    ...
    private class SlopeOrder implements Comparator<Point> {
        ...
        public int compare(Point arg0, Point arg1) {
            ...
            if (thisPoint.slopeTo(arg0) > thisPoint.slopeTo(arg1))
                return 1;
            else if (thisPoint.slopeTo(arg0) < thisPoint.slopeTo(arg1))
                return -1;
            return 0;
        }
    ...
    public static void main(String[] args) {
        ...
        // }
        // Arrays.sort(points);
        // Comparator<Point> op = points[1].slopeOrder();
        // System.out.println(
        // "points[0]=" + points[0] + "_" + points[1] + "_" + points[2] +
        // op.compare(points[5], points[1]));
    }
}